...
public sealed class SaveCallLogHandler : PhoneCallHandlerBase
{
    public SaveCallLogHandler(IUnitOfWork unitOfWork, IBlockedPeersRepository blockedPeersRepository, IAuthorizationRepository authorizationRepository, IUserRepository userRepository, ICallRegistry registry,
    ...
    [TLFunction(Constructors.baseLayer_SaveCallLog)]
    public async ValueTask<TLBool> Handle(long authKeyId, TLBytes q)
    {
        var request = (SaveCallLog)q;
