...
/// <summary>
/// The single source of truth for which peers an account may send as, shared by
/// channels.getSendAs and messages.saveDefaultSendAs.
/// </summary>
public static class SendAsResolver
{
    ...
    /// <summary>
    /// Tests one selected author against the same set exposed by
    /// channels.getSendAs: the account itself, or a channel it creates/administers
    /// with post rights.
    /// </summary>
    ...
    /// <summary>
    /// Resolves the authored peer for a send. Telegram's send-as surface is a
    /// channel-dialog feature: private/basic-group sends stay self-authored and
    /// reject a wire send_as instead of leaking a channel identity into a common
    /// message box. An explicit channel selection wins over the durable default.
    /// </summary>
