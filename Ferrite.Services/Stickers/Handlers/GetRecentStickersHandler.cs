...
{
    public GetRecentStickersHandler(IUnitOfWork unitOfWork, IAuthorizationRepository authorizationRepository, StickerStore store)
    ...
    public async Task<TLBytes> Handle(long authKeyId, TLBytes q)
    {
        ...
        return userId.HasValue
            ? await Store.GetRecentAsync(userId.Value, attached, hash)
            : AuthError();
    }
}
