...
/// <summary>
/// Durable account-scoped peer-folder, pin, and manual-unread state. Filter and
/// chatlist operations join this store in the following tasks.
/// </summary>
public sealed class DialogOrganizationStore
{
        ...
        IReadOnlyList<DialogFolderMove> moves)
    {
        ...
        if (moves.Count == 0)
        {
            return _fanout.BuildUpdates([], [], [], Now(), seq: 0);
        }
