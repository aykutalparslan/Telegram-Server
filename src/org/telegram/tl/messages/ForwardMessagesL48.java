...
public class ForwardMessagesL48 extends TLObject {
    ...
    public ForwardMessagesL48() {
        this.id = new TLVector<>();
        this.random_id = new TLVector<>();
    }

    public ForwardMessagesL48(int flags, TLInputPeer from_peer, TLVector<Integer> id, TLVector<Long> random_id, TLInputPeer to_peer) {
        this.flags = flags;
    ...
    public boolean is_forwardMessagesL48_with_my_score() {
        return (flags & (1 << 8)) != 0;
    }

    public boolean set_forwardMessagesL48_with_my_score() {
        return (flags |= (1 << 8)) != 0;
    }
