...
public class ConfigL48 extends TLConfig {

    public static final int ID = 0x317ceef4;
    ...
    public ConfigL48(int date, int expires, boolean test_mode, int this_dc, TLVector<TLDcOption> dc_options,
                     int chat_size_max, int broadcast_size_max, int forwarded_count_max,
                     int online_update_period_ms, int offline_blur_timeout_ms, int offline_idle_timeout_ms,
                     int online_cloud_timeout_ms, int notify_cloud_delay_ms, int notify_default_delay_ms,
                     int chat_big_size, int push_chat_period_ms, int saved_gifs_limit, int edit_time_limit,
                     int push_chat_limit, TLVector<TLDisabledFeature> disabled_features) {
        this.date = date;
