...
public class ping_delay_disconnect extends TLObject implements TLMethod{
    ...
    public void deserialize(ProtocolBuffer buffer) {
        ...
        disconnect_delay = buffer.readInt();
    }
    ...
    public void serializeTo(ProtocolBuffer buff) {
        ...
        buff.writeInt(disconnect_delay);
    }
    ...
    public TLObject execute(TLContext context, long messageId, long reqMessageId) {
        return new Pong(messageId, ping_id);
    }
}