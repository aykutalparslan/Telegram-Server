...
public class InputBotInlineResult extends TLInputBotInlineResult {
    ...
    public InputBotInlineResult(int flags, String id, String type, String title, String description, String url, String thumb_url, String content_url, String content_type, int w, int h, int duration, TLInputBotInlineMessage send_message) {
        this.flags = flags;
        this.id = id;
        this.type = type;
        this.title = title;
