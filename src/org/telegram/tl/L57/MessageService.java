...
public class MessageService extends TLMessage {
    ...
    public MessageService(int flags, int id, int from_id, TLPeer to_id, int reply_to_msg_id, int date, TLMessageAction action) {
        this.flags = flags;
        this.id = id;
