...
public class BotInlineMessageMediaVenue extends TLBotInlineMessage {
    ...
    public BotInlineMessageMediaVenue(int flags, TLGeoPoint geo, String title, String address, String provider, String venue_id, TLReplyMarkup reply_markup) {
        this.flags = flags;
        this.geo = geo;
        this.title = title;
