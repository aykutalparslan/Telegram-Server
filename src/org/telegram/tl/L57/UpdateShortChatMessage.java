...
public class UpdateShortChatMessage extends TLUpdates {
    ...
    public UpdateShortChatMessage(int flags, int id, int from_id, int chat_id, String message, int pts, int pts_count, int date, TLMessageFwdHeader fwd_from, int via_bot_id, int reply_to_msg_id, TLVector<TLMessageEntity> entities) {
        this.flags = flags;
        this.id = id;
