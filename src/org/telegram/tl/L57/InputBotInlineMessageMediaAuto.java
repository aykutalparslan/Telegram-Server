...
public class InputBotInlineMessageMediaAuto extends TLInputBotInlineMessage {
    ...
    public InputBotInlineMessageMediaAuto(int flags, String caption, TLReplyMarkup reply_markup) {
        this.flags = flags;
