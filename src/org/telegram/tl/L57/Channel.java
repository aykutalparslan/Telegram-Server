...
public class Channel extends TLChat {
    ...
    public Channel(int flags, int id, long access_hash, String title, String username, TLChatPhoto photo, int date, int version, String restriction_reason) {
        this.flags = flags;
        this.id = id;
