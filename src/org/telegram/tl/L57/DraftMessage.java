...
public class DraftMessage extends TLDraftMessage {
    ...
    public DraftMessage(int flags, int reply_to_msg_id, String message, TLVector<TLMessageEntity> entities, int date) {
        this.flags = flags;
