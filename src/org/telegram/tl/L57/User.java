...
public class User extends TLUser {
    ...
    public User(int flags, int id, long access_hash, String first_name, String last_name, String username, String phone, TLUserProfilePhoto photo, TLUserStatus status, int bot_info_version, String restriction_reason, String bot_inline_placeholder) {
        this.flags = flags;
        this.id = id;
