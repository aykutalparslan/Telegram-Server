...
public class BotInlineResult extends TLBotInlineResult {
    ...
    public BotInlineResult(int flags, String id, String type, String title, String description, String url, String thumb_url, String content_url, String content_type, int w, int h, int duration, TLBotInlineMessage send_message) {
        this.flags = flags;
        this.id = id;
        this.type = type;
        this.title = title;
