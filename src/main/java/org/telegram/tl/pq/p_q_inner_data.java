 ...
 */
public class p_q_inner_data extends TLObject{
    ...
    public p_q_inner_data(){

    }

    public p_q_inner_data(byte[] pq, byte[] p, byte[] q,byte[] nonce, byte[] server_nonce,  byte[] new_nonce){
        this.pq = pq;
        this.p = p;
        this.q = q;
