 ...
 */
public class dh_gen_retry extends TLObject{
    ...
    public dh_gen_retry(byte[] nonce, byte[] server_nonce, byte[] new_nonce_hash2){
        ...
        if (new_nonce_hash2 == null || new_nonce_hash2.length != 16) {
            throw new IllegalArgumentException("must be 16 bytes");
        }
    ...
    public void deserialize(ProtocolBuffer buffer) {
        ...
        new_nonce_hash2 = buffer.read(16);
    }
