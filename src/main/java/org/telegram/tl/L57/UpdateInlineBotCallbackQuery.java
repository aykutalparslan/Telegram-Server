...
public class UpdateInlineBotCallbackQuery extends org.telegram.tl.TLUpdate {

    public static final int ID = 0xf9d27a5a;
    ...
    public UpdateInlineBotCallbackQuery() {
    }

    public UpdateInlineBotCallbackQuery(int flags, long query_id, int user_id, org.telegram.tl.TLInputBotInlineMessageID msg_id, long chat_instance, byte[] data, String game_short_name) {
        this.flags = flags;
