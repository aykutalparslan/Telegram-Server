...
public class UpdateDraftMessage extends org.telegram.tl.TLUpdate {
    ...
    public UpdateDraftMessage(org.telegram.tl.TLPeer peer, org.telegram.tl.TLDraftMessage draft) {
        this.peer = peer;
        this.draft = draft;
    }
