...
public class InputBotInlineMessageMediaContact extends org.telegram.tl.TLInputBotInlineMessage {
    ...
    public InputBotInlineMessageMediaContact(int flags, String phone_number, String first_name, String last_name, org.telegram.tl.TLReplyMarkup reply_markup) {
        this.flags = flags;
