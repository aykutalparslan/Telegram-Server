...
public class UpdateReadHistoryOutbox extends org.telegram.tl.TLUpdate {
    ...
    public UpdateReadHistoryOutbox(org.telegram.tl.TLPeer peer, int max_id, int pts, int pts_count) {
        this.peer = peer;
        this.max_id = max_id;
        this.pts = pts;
