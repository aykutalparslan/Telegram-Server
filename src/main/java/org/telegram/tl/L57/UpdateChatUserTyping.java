...
public class UpdateChatUserTyping extends org.telegram.tl.TLUpdate {
    ...
    public UpdateChatUserTyping(int chat_id, int user_id, org.telegram.tl.TLSendMessageAction action) {
