...
public class Suggested extends TLSuggested {

    public static final int ID = 1447681221;
    ...
    public void deserialize(ProtocolBuffer buffer) {
        results = (TLVector<TLContactSuggested>) buffer.readTLObject(APIContext.getInstance());
